...
public class TwoPhaseCohortMain3 {

	public static void main(String[] args) {

//		InetSocketAddress serverhostAddress = new InetSocketAddress("localhost", 11116);
//		InetSocketAddress clienthostAddress = new InetSocketAddress("localhost", 11115);
...
//		coordinator.sendEvent(new InitClient());
	    ...
	    int coordinatorPort = 11115;
        int port = 11116;
        
        int chort1Port = 11119;
        int port2 = 11120;
	    ...
	    SynchronousSocketBoundaryObjectFeature cohort1 = new SynchronousSocketBoundaryObjectFeature(port2, chort1Port, null, new BricksStrategy(), COORD_REMOTE);
